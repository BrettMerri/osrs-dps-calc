...
const PlayerContainer: React.FC = observer(() => {
  ...
  const {
    loadouts, player, selectedLoadout, selectedLoadoutId, canCreateLoadout, createLoadout, renameLoadout, deleteLoadout, setSelectedLoadoutId, moveLoadout,
  } = store;
  ...
  return (
    <div className="flex flex-col w-[350px]">
      ...
      >
        <LoadoutTabs loadouts={loadouts} selectedLoadoutId={selectedLoadoutId} setSelectedLoadoutId={setSelectedLoadoutId} moveLoadout={moveLoadout} />
        <div>
          <button
            type="button"
